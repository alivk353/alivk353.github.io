...
### nccloud.framework.web.action.entry.NCCloudContextListener

>  ConfigCacheServer.getInstance().load();

```java

0 = "nccloud.framework.web.action.define.ActionConfigReader"
1 = "nccloud.framework.web.def.freedef.FreedefConfigReader"
2 = "nccloud.framework.web.def.userdef.UserdefConfigReader"
3 = "nccloud.framework.core.config.AppAuthenticationConfigReader"
4 = "nccloud.framework.web.action.relation.LoadTranRelationReader"
5 = "nccloud.framework.core.config.LicenseCheckServiceConfigReader"
6 = "nccloud.framework.core.config.MobConfigReader"
7 = "nccloud.framework.core.config.uploadwhitelist.UploadWhiteListDefineConfigReader"

```

"userdef" -> {UserdefConfigReader@12225} 
"checklicense" -> {LicenseCheckServiceConfigReader@12258} 
"mobconfig" -> {MobConfigReader@12260} 
"uploadwhitelist" -> {UploadWhiteListDefineConfigReader@12262} 
"action" -> {ActionConfigReader@12204} 

nccloud.framework.web.action.define.ActionConfig 解析配置为实体

nccloud.framework.web.action.define.ActionDefine 配置实体

nccloud.framework.core.config.ConfigCacheServer 全局配置缓存  

     ConfigCacheServer.getInstance().getCache(ActionDefine.class)
     MemeryCacheServer.getInstance().getCache("nccloud.framework.web.action.define.ActionDefine", true);
     ConfigCacheServer.getInstance().getCache(AppAuthenticationDefine.class) 

"tran_relation" -> {LoadTranRelationReader@12264} 
"freedef" -> {FreedefConfigReader@12218} 
    

 "authorize" -> {AppAuthenticationConfigReader@12238} 
